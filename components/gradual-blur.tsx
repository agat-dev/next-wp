...
const GradualBlur: React.FC<PropsWithChildren<GradualBlurProps>> = props => {
  ...
  const blurDivs = useMemo(() => {
    ...
    for (let i = 1; i <= config.divCount; i++) {
      ...
      // Lignes du blanc pur au transparent, sans couleur intermédiaire
      const lineColor = '#fff';
      let gradient = `transparent ${p1}%, ${lineColor} ${p2}%, transparent ${p3}%`;
      // On ne garde que le passage blanc -> transparent, sans palier intermédiaire
