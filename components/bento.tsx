...
const BentoCard = ({
  ...
  >
    <div>{background}</div>
    <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 pt-0 transition-all duration-300">
...
export const HoverEffectBento = ({
    ...
    return (
      <div
        className={cn(
          "grid w-full auto-rows-[8rem] grid-cols-6 py-4 ",
          className
        )}
      >
        {items.map((item, idx) => (
